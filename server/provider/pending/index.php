...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    $statement = $connection->prepare("SELECT appointment.available, firstname, surname, telephone, available.datetime, dose, person.account FROM person INNER JOIN appointment
